...
protected:
	...
	/** Función para resetear la capacidad de disparar */
	void ResetFire();

	/** Offset desde la ubicación del personaje para generar proyectiles */
...
public:
	...
	// Propiedad de salud del personaje
...
public:
	...
	// Propiedad que indica si el personaje tiene un arma equipada
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Weapon")
	bool bHasWeapon;

	// Método para mostrar las propiedades del personaje
